...
Команда также обновляет через Telegram Bot API поле профиля «Что умеет этот бот?» и аватар: `images/avatar.png` для бизнес-версии, `images/redirect_avatar.png` для версии-переходника.
